...
const TypeWriterEffect = ({
  ...
  return (
    <div className={cn("text-xs  md:text-lg lg:text-2xl font-extralight", className)}>
      {renderWords()}
      <motion.span
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, repeat: Infinity, repeatType: "reverse" }}
        className={cn("rounded-xs w-[4px] h-4 md:h-6 lg:h-6 bg-blue-500 relative -top-0.5 md:-top-0.4 flex flex-wrap")}
