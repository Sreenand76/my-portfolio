    ...
    <h2 className='text-gray-200 flex text-3xl lg:text-5xl mb-5 justify-left ml-2 md:justify-center'>Skills</h2>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-5 gap-x-6 p-2 md:gap-5 lg:gap-10 lg:p-4 justify-center">
        {skills.map(skill => (
          <motion.div
            key={skill.id}
            className="flex flex-col text-gray-500 text-xs md:text-sm items-center justify-center py-4 px-4 lg:py-6 2xl:py-10 border border-gray-700 rounded hover:brightness-130 hover:text-white shadow-md hover:border-gray-200"
